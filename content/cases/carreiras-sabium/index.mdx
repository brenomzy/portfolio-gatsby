...
import FluxoAtual from './fluxo-atual.png';
import HeaderCarreiras from './header_carreiras.png';
import VagasCarreiras from './vagas_carreiras.png';
...
<ZoomImage src={FluxoAtual} alt='Fluxo de cadastro antigo' />
...
<ZoomImage src={HeaderCarreiras} alt='Header do novo site' />
...
<ZoomImage src={VagasCarreiras} alt='Benefícios da empresa' />
