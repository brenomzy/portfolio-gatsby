...
import Enderecos from './enderecos.png';
import Contatos from './contatos.png';
import Bancos from './bancos.png';
...
<ZoomImage src={Pessoa} alt='Cadastro de pessoas' />
...
<ZoomImage src={Enderecos} alt='Antes e depois da aba Endereços' />
<ZoomImage src={Contatos} alt='Antes e depois da aba Contatos' />
<ZoomImage src={Bancos} alt='Antes e depois da aba Bancos' />
